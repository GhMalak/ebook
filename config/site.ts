...
export const site = {
  ...
  titulo: "FTM - ASHER DIGITAL",

  /** Razão social (nome legal da empresa) */
  razaoSocial: "Emerson Brandao Silva",

  /** CNPJ (apenas números ou formatado) */
  cnpj: "49.645.116/0001-77",

  /** Data de abertura */
  dataAbertura: "17/02/2023",
  ...
  missao:
    "Oferecer serviços de excelência, com agilidade e comprometimento, proporcionando a melhor experiência e soluções personalizadas para nossos clientes. Atuamos com a transparência e a responsabilidade de um Microempreendedor Individual (MEI), valorizando o crescimento sustentável e o relacionamento próximo, para transformar necessidades em resultados concretos.",

  /** Por que essa missão se adequa ao seu negócio (pode ser um array de frases ou um texto) */
  missaoAdequacao: `Foco no Cliente: A razão social leva o seu nome, o que indica um negócio pessoal e com foco no relacionamento próximo. A missão reflete isso.
...
Espírito Empreendedor: A natureza jurídica de Empresário Individual e o porte MEI são a essência do empreendedorismo brasileiro. A missão captura esse espírito de crescimento e dedicação.`,

  /** Título da seção Quem Somos */
  quemSomosTitulo: "Conheça a Nossa História",

  /** Texto "Sobre Nós" / Quem somos */
  quemSomosTexto: `A empresa nasceu da vontade de oferecer um trabalho de qualidade, transparente e próximo do cliente. Formalizada como Microempreendedor Individual (MEI), nossa empresa foi construída sobre a base do empreendedorismo honesto e dedicado, com um capital social investido para garantir seriedade e compromisso desde o primeiro dia.
